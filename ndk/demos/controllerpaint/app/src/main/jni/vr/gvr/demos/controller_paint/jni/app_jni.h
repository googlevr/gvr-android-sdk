...
#ifndef VR_GVR_DEMOS_CONTROLLER_PAINT_JNI_APP_JNI_H_
#define VR_GVR_DEMOS_CONTROLLER_PAINT_JNI_APP_JNI_H_
...
#endif  // VR_GVR_DEMOS_CONTROLLER_PAINT_JNI_APP_JNI_H_
